...
import { Coins, FileText, Lightbulb, Send, ShoppingBag, Sparkles, TriangleAlert } from 'lucide-vue-next';
        ...
        <div class="mt-6 grid gap-6 xl:grid-cols-[1fr_1.2fr]">
            <section class="panel">
                <div class="panel-header">
                    ...
                    <Link href="/stores" class="btn btn-secondary">Manage</Link>
                </div>
            ...
            <section class="panel">
                <div class="panel-header">
                    ...
                    <Link href="/stores" class="btn btn-secondary">Analyze</Link>
                </div>
